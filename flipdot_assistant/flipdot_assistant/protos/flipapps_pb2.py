...
# source: flipdot_assistant/protos/flipapps.proto
...
TextRequest = _reflection.GeneratedProtocolMessageType('TextRequest', (_message.Message,), dict(
  ...
  __module__ = 'flipdot_assistant.protos.flipapps_pb2'
